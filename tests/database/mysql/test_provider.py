...
def test_init_runners_correctly(execution):
    ...
    """
    MySqlProvider("1.2.3.4", "root", "password", "db_name", cmd_opts="--test-arg=cmd", dump_opts="--test-arg=3")
    execution.MySqlCmdRunner.assert_called_once_with(db_host="1.2.3.4", db_user="root", db_pass="password", db_name="db_name", db_port="3306", additional_opts="--test-arg=cmd" )
